  ...
  return (
    <div>
        ...
        <form>
            ...
            <br></br>
            <br></br>
            <button CLASS="submitButton" onClick={handleConfirmChanges}>Confirm Changes</button>
            <br></br>
            <br></br>
            <button CLASS="submitButton" onClick={handleDeleteAccount}>Delete Account</button>
        </form>
    </div>
  );
}
